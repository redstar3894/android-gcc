...
/* Functions specific to simplify-got.  */
#ifndef TARGET_GET_PIC_REG
#define TARGET_GET_PIC_REG hook_rtx_void_null
#endif

#ifndef TARGET_CLEAR_PIC_REG
#define TARGET_CLEAR_PIC_REG NULL
#endif

#ifndef TARGET_LOADED_GLOBAL_VAR
#define TARGET_LOADED_GLOBAL_VAR NULL
#endif

#ifndef TARGET_CAN_SIMPLIFY_GOT_ACCESS
#define TARGET_CAN_SIMPLIFY_GOT_ACCESS NULL
#endif

#ifndef TARGET_LOAD_GLOBAL_ADDRESS
#define TARGET_LOAD_GLOBAL_ADDRESS NULL
#endif

#define TARGET_GOT_ACCESS_HOOKS                 \
  {                                             \
    TARGET_GET_PIC_REG,                         \
    TARGET_CLEAR_PIC_REG,                       \
    TARGET_LOADED_GLOBAL_VAR,                   \
    TARGET_CAN_SIMPLIFY_GOT_ACCESS,             \
    TARGET_LOAD_GLOBAL_ADDRESS,                 \
  }
